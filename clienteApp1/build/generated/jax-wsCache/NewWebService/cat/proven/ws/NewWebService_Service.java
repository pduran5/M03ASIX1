 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ws.proven.cat/", wsdlLocation = "http://localhost:8080/WebApplication1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ws.proven.cat/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ws.proven.cat/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.proven.cat/", "NewWebServicePort"), NewWebService.class, features);
    }
