...
public class ObjectFactory {
    ...
    private final static QName _HelloResponse_QNAME = new QName("http://ws.proven.cat/", "helloResponse");
    private final static QName _AdiosResponse_QNAME = new QName("http://ws.proven.cat/", "adiosResponse");
    private final static QName _Hello_QNAME = new QName("http://ws.proven.cat/", "hello");
    private final static QName _Adios_QNAME = new QName("http://ws.proven.cat/", "adios");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.proven.cat/", name = "helloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.proven.cat/", name = "adiosResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.proven.cat/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.proven.cat/", name = "adios")
